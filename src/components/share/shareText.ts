export const VALUE_SHARE: Record<
  string,
...
> = {
  ...
  LEISTUNG: {
    title: "Leistung",
    description:
      "Setze dir Ziele und arbeite konsequent darauf hin. Auch, wenn du nicht jedes Ziel erreichst, kannst du dein Bestes geben und zeigen, was in dir steckt. Damit schaffst du Erfolgserlebnisse. Wenn du gemeinsam mit anderen arbeitest, schweißt das zusammen und ihr entwickelt eure Fähigkeiten weiter.",
  },
  GENUSS: {
    title: "Genuss",
    description:
...
export const STRENGTH_SHARE: Record<
  string,
  { title: string; description: string }
> = {
  EMPATHIE: {
